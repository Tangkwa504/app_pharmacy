...
@injectable
class UploadLicensesPhamarcyUsecase extends UseCase<XFile, String> {
  UploadLicensesPhamarcyUsecase();
  ...
  Future<String> exec(XFile request) async {
    try {
      ...
      final storageRef = FirebaseStorageProvider.storage.ref('licenses/$name');
