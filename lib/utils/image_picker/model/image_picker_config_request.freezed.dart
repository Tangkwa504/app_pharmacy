...
class _$ImagePickerConfigRequestImpl implements _ImagePickerConfigRequest {
  ...
  @override
  String toString() {
    return 'ImagePickerConfigRequest(type: $type, source: $source, maxWidth: $maxWidth, maxHeight: $maxHeight, imageQuality: $imageQuality)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, type, source, maxWidth, maxHeight, imageQuality);
...
abstract class _ImagePickerConfigRequest implements ImagePickerConfigRequest {
  const factory _ImagePickerConfigRequest(
      ...
      final double? maxWidth,
      final double? maxHeight,
      final int? imageQuality}) = _$ImagePickerConfigRequestImpl;
